...
export const getTemperatureMonitoringChartData = data => {
  ...
  //     name: "Heat Alarms",
  //     data: [
  //       convertToTimeSeries(month.year, month.month),
  //       parseInt(month.heat_alarm__sum)
  //     ],
  //     stack: month.month
  //   });
  //   cold_alarms.push({
  ...
  //     data: [
  //       convertToTimeSeries(month.year, month.month),
  //       parseInt(month.cold_alarm_sum)
  //     ],
  //     stack: month.month
  //   });
  // });

  // console.log(heat_alarms);

  // // const sorted_heat_alarms = dataSorter(heat_alarms);
  // // const sorted_cold_alarms = dataSorter(cold_alarms);

  // // chartData.push({
  // //   name: "Heat Alarms",
  // //   // data: sorted_heat_alarms,
  // //   color: "#BBE0E3"
  // // });

  // // chartData.push({
  // //   name: "Freeze Alarms",
  // //   // data: sorted_cold_alarms,
  // //   color: "#33339A"
  // // });
  // chartData.push(...heat_alarms, ...cold_alarms);
  // return chartData;
};
