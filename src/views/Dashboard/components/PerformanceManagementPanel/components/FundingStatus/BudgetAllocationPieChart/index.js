...
// Chart Template
import { BudgetAllocationPieChartTemplate } from "./chart";
...
const BudgetAllocationPieChart = () => {
  ...
  useMemo(() => {
    setChart(BudgetAllocationPieChartTemplate());
    //eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isLoading]);

  return (
    <Chart
      title={"Budget Allocation (National vs District)"}
      chart={
...
export default BudgetAllocationPieChart;
