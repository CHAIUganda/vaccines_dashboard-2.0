...
export const DataTable = () => {
  ...
  const setEditFields = (rowData, index, key) => {
    if (key === "status") {
      return rowData?.activity_status?.[index] === undefined
        ? "never"
        : "onUpdate";
  ...
  const [columns, setColumns] = useState([
    ...
    },
    {
      ...
      // editable: "onUpdate",
      editable: (rowData) =>
        getRowData(rowData, 2, "status") === "No Data" ? "never" : "onUpdate",
    },
    {
    ...
    },
    {
      ...
      lookup: statuses,
      editable: (rowData, rest) => setEditFields(rest, 3, "status"),
      // const status = setEditFields(rest, 3, "status");
      // console.log(status);
      // console.log(rowData);

      // console.log(status === "No Data" ? "never" : "onUpdate");

      // return status === "No Data" ? "never" : "onUpdate";

      // getRowData(rest, 3, "status") === "No Data" ? "never" : "onUpdate",
    },

    {
      ...
      editable: (rowData) =>
        getRowData(rowData, 3) === "No Data" ? "never" : "onUpdate",
      width: 150,
    },
    {
    ...
    // },
    {
      ...
      cellStyle: (rowData) => styles.rowContent,
      headerStyle: styles.headerShort,
      render: (rowData) => rowData.objective,
      editable: "never",
    },
    {
      field: "funding_source_organization",
      title: "Funding Source",
      cellStyle: (rowData) => styles.rowContent,
      headerStyle: styles.headerShort,
      render: (rowData) => rowData.funding_source_organization.name,
      editable: "never",
    },
    {
      field: "funding_state",
      ...
      cellStyle: (rowData) => styles.rowContent,
      headerStyle: styles.headerShort,
      render: (rowData) => rowData.funding_state,
      editable: "never",
    },
    {
      field: "funding_priority_level",
    ...
    },
    {
      ...
      cellStyle: (rowData) => styles.rowContent,
      headerStyle: styles.headerShort,
      render: (rowData) => rowData.time_frame,
      editable: "never",
    },
    {
      field: "verification",
      ...
      cellStyle: (rowData) => styles.rowContent,
      headerStyle: styles.headerShort,
      render: (rowData) => rowData.verification,
      editable: "never",
    },
    ...
    {
      field: "stackholder_focal_point",
      title: "Stakeholder Focal Point",
      cellStyle: (rowData) => styles.rowContent,
      headerStyle: styles.headerShort,
      render: (rowData) => rowData.stackholder_focal_point,
      editable: "never",
    },
  ]);
        ...
        isAuthenticated
          ? {
              onRowUpdate: (newData, oldData) =>
                updateActivitiesData(newData, oldData, data),
            }
          : {}
      }
    />
